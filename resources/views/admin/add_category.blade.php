        ...
        <form class="form-horizontal" action="{{url('/save_category')}}" method="post" >
              ...
              <fieldset>
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="text" class="input-xlarge" id="name" name="category_name" required="" placeholder="Enter a Category Name">
                  </div>
                </div>
                ...
                <div class="control-group hidden-phone">
                  ...
                  <div class="controls">
                    <textarea class="cleditor" id="description" name="category_description" required="" rows="3"></textarea>
                  </div>
                </div>
