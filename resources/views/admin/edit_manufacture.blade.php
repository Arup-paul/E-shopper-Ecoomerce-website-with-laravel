        ...
        <form class="form-horizontal" action="{{url('/update_manufacture/'.$manufacture_info->manufacture_id)}}" method="post" >
              ...
              <fieldset>
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                  <input type="text" class="input-xlarge" id="name" name="manufacture_name" required="" value="{{$manufacture_info->manufacture_name}}">
                  </div>
                </div>
                ...
                <div class="control-group hidden-phone">
                  ...
                  <div class="controls">
                    <textarea class="cleditor" id="description" name="manufacture_description" required="" rows="3">
