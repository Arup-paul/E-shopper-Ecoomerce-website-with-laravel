...
<head>
	...
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title>Admin Login - Eshopper </title>
		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
				<div class="login-box">
                    ...
                    <h2 style="color:red; font-size:20px; display:inline-block;">
                      <?php
                      $msg  = Session::get('msg');
                        if($msg){
                            echo $msg;
					...
					<form class="form-horizontal" action="{{URL::to('/admin_dashboad')}}" method="post">
                    {{csrf_field()}}
						<fieldset>
